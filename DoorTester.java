...
public class DoorTester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Expected: open");
        // Use the mutator to change the name variable
        sideDoor.setName("Kitchen");
        System.out.println("The side door is called " + sideDoor.getName());
        System.out.println("Expected: Kitchen");
    }
} 

// 8) state is instance variable, exists in the whole Door class
// newState is a parameter variable, exists during the setState method (set method)

// 9) Implicit parameter is backDoor object
// Explicit parameter is "open"